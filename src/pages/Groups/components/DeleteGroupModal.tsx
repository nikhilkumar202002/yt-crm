...
import { deleteGroup } from '../../../api/services/microService';
...
export const DeleteGroupModal = ({ group, isOpen, onOpenChange, onSuccess }: DeleteGroupModalProps) => {
        ...
        <Dialog.Content className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-sm bg-white rounded-2xl p-6 shadow-2xl z-[110] font-sans">
          <div className="flex justify-between items-center mb-6">
            <Dialog.Title className="text-sm font-bold text-red-600 uppercase tracking-wider flex items-center gap-2">
              <AlertTriangle size={16} className="text-red-600" /> Delete Group
            </Dialog.Title>
          ...
          <div className="text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-slate-600 text-sm leading-relaxed">
                Are you sure you want to delete <span className="font-medium text-slate-900">"{group?.name}"</span>?
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-3">
              <div className="flex items-start gap-2">
                ...
                <div className="text-xs text-red-700">
                  ...
                  <p>This will permanently remove the group and may affect related data.</p>
                </div>
              </div>
            </div>
          </div>
